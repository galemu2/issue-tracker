...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "f6e2dfb5ae484a21d787";
...
const app1 = express__WEBPACK_IMPORTED_MODULE_1___default()();
source_map_support__WEBPACK_IMPORTED_MODULE_3___default.a.install();
dotenv__WEBPACK_IMPORTED_MODULE_0___default.a.config({
  path: '/home/galemu00/Documents/JavaScript/React/proMERN/mern-2/ui/sample.env'
...
const staticMidelware = express__WEBPACK_IMPORTED_MODULE_1___default.a.static('public');
app1.use(staticMidelware);
const apiProxyTarget = process.env.API_PROXY_TARGET;

if (apiProxyTarget) {
  app1.use('/graphql', http_proxy_middleware__WEBPACK_IMPORTED_MODULE_2___default()({
    target: apiProxyTarget
  }));
  app1.use('/auth', http_proxy_middleware__WEBPACK_IMPORTED_MODULE_2___default()({
    target: apiProxyTarget
  }));
}
...
class DateInput extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  render() {
    ...
    const {
      ...
      onValidityChange,
      ...props
    } = this.props; // const className = (!valid && !focused) ? 'invalid' : null;
...
class IssueEdit extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  render() {
    ...
    } = this.state; // const { issue: { } } = this.state;
...
class IssueFilter extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  render() {
    const {
      status,
      changed
    } = this.state; // const { location: { search } } = this.props;
...
class IssueList extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  async deleteIssue(index) {
    ...
    if (data && data.issueDelete) {
      ...
      const undeoMessage = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, `Deleted issue ${id} successfully.`, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_2__["Button"], {
        bsStyle: "link",
...
function IssueTable({
  ...
  const issueRows = isIssues.map((issue, index) => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(IssueRow, {
    key: issue.id,
    issue: issue,
...
function NavBar({
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react_bootstrap__WEBPACK_IMPORTED_MODULE_1__["Navbar"], {
    ...
    pullRight: true
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_IssueAddNavItem_jsx__WEBPACK_IMPORTED_MODULE_4__["default"], {
    user: user
  }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_SignInNavItem_jsx__WEBPACK_IMPORTED_MODULE_6__["default"], {
    user: user,
